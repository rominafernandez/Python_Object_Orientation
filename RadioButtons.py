...
# radio buttons
radio_german = tk.Radiobutton(frame_radiob, text = "German", variable = var_lan, value = "german", command = changeLan, font = normal_font)
radio_english = tk.Radiobutton(frame_radiob, text = "English", variable = var_lan, value = "english", command = changeLan, font = normal_font)
radio_spanish = tk.Radiobutton(frame_radiob, text = "Spanish", variable = var_lan, value = "spanish", command = changeLan, font = normal_font)
radio_french = tk.Radiobutton(frame_radiob, text = "French", variable = var_lan, value = "french", command = changeLan, font = normal_font)
radio_danish = tk.Radiobutton(frame_radiob, text = "Danish", variable = var_lan, value = "danish", command = changeLan, font = normal_font)
radio_italian = tk.Radiobutton(frame_radiob, text = "Italian", variable = var_lan, value = "italian", command = changeLan, font = normal_font)
